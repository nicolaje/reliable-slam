// This file is generated from ibex_Java.cpp_.
#include "ibex_Ibex.h_"
//============================================================================
//                                  I B E X                                   
// File        : Ibex.cpp
...
JNIEXPORT void JNICALL Java_ibex_Ibex_add_1ctr__ILjava_lang_String_2(JNIEnv *env, jobject o, jint nb_var, jstring syntax) {
	Java_ibex_Ibex_add_1ctr__ILjava_lang_String_2I(env,o,nb_var,syntax,COMPO);
}
...
JNIEXPORT void JNICALL Java_ibex_Ibex_add_1ctr__ILjava_lang_String_2I(JNIEnv *env, jobject, jint nb_var, jstring syntax, jint option) {
...
JNIEXPORT void JNICALL Java_ibex_Ibex_add_1int_1ctr(JNIEnv *env, jobject o, jint nb_var) {
	sys.push_back(NULL);
...
JNIEXPORT jint JNICALL Java_ibex_Ibex_contract__I_3D(JNIEnv *env, jobject o, jint n, jdoubleArray domains) {
	return Java_ibex_Ibex_contract__I_3DI(env,o,n,domains,1);
}
...
JNIEXPORT jint JNICALL Java_ibex_Ibex_contract__I_3DI(JNIEnv *env, jobject, jint n, jdoubleArray domains, jint reif) {
	jboolean isCopy;
...
JNIEXPORT jint JNICALL Java_ibex_Ibex_inflate(JNIEnv *env, jobject, jint n, jdoubleArray p, jdoubleArray X, jboolean in) {
...
JNIEXPORT void JNICALL Java_ibex_Ibex_release(JNIEnv *, jobject) {
