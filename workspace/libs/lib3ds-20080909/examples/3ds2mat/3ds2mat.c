...
/**
    @example 3ds2m.c
    A utility to create vertices and faces matrices for matlab patch fro a 3ds file.
*/
...
help() {
    fprintf(stderr,
            "The 3D Studio File Format Library - 3ds2mat\n"
            "Copyright (C) 2010 by Yann MORERE\n"
            "All rights reversed.\n"
            "\n"
            "Syntax: 3ds2mat [options] filename [options] > fichier.mat\n"
            "\n"
            "Options:\n"
            "  -h           This help\n"
...
/*
	printf("  %s vertices=%ld faces=%ld\n",
        ...
        mesh->nfaces);
		*/
    printf("  matrix%d=[", compte_mesh);
	matrix_dump(mesh->matrix);
	printf("];\n");
    //printf("  vertices (x, y, z, u, v):\n");
	printf("vertices%d=[ ",compte_mesh);
