 ...
 *--------------------------------------------------------------------------
 * CVS: $Id: gaol_flt_output.h,v 1.4 2007/09/12 12:41:58 goualard Exp $
 * Last modified: 
 * By: 
 *--------------------------------------------------------------------------*/
...
*/
  extern _GAOL_DLL_ char* dtoa_downward(double d, std::ostream& os);
/*!
  \brief Prints the double d to the stream os with upward rounding for
  the conversion digits->ASCII
*/
  extern _GAOL_DLL_ char* dtoa_upward(double d, std::ostream& os);
